...
<div class="container">
	...
	<div class="panel panel-default">
		...
		<ul class="list-group">
			...
			<li class="list-group-item">Copy the content of <a href="https://alexa.zpriddy.com/alexa/nest/static/intentSchema.json">this page</a> into the Intent Schema</li>
			<li class="list-group-item">Copy the content of <a href="https://alexa.zpriddy.com/alexa/nest/static/sampleUtterances.txt">this page</a> into the Sample Utterances</li>
			<li class="list-group-item">Click on Next</li>
